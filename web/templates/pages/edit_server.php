		...
		<div class="form-container">
			...
			<?php if (!empty($_SESSION["HAPROXY_SYSTEM"]) || !empty($_SESSION["MONGODB_SYSTEM"]) || !empty($_SESSION["NODEJS_SYSTEM"]) || !empty($_SESSION["PYTHON_SYSTEM"]) || !empty($_SESSION["RABBITMQ_SYSTEM"]) || !empty($_SESSION["KAFKA_SYSTEM"]) || !empty($_SESSION["REDIS_SYSTEM"])) { ?>
				<details class="box-collapse u-mb10">
					...
					<div class="box-collapse-content">
						<!-- HAProxy -->
						<?php if (!empty($_SESSION["HAPROXY_SYSTEM"]) && $_SESSION["HAPROXY_SYSTEM"] == "yes") { ?>
							<div class="u-mb20">
								<p class="u-mb10">
									<i class="fas fa-network-wired icon-purple u-mr5"></i>
									<?= _("HAProxy Load Balancer") ?>:
									<span class="u-ml5 u-text-bold"><?= _("Enabled") ?></span>
									<a href="/edit/server/haproxy/" class="u-ml5">
										<i class="fas fa-pencil icon-orange"></i>
									</a>
									<a href="/list/haproxy/" class="u-ml5">
										<i class="fas fa-chart-bar icon-blue"></i>
									</a>
								</p>
								<div class="u-pl30">
									<p class="hint">
										<?= _("Stats Port") ?>: <?= htmlentities($_SESSION["HAPROXY_STATS_PORT"] ?? "8404") ?>
									</p>
								</div>
							</div>
						<?php } ?>
						...
						<!-- MongoDB -->
						<?php if (!empty($_SESSION["MONGODB_SYSTEM"]) && $_SESSION["MONGODB_SYSTEM"] == "yes") { ?>
							<div class="u-mb20">
								<p class="u-mb10">
									<i class="fas fa-leaf icon-green u-mr5"></i>
									<?= _("MongoDB") ?>:
									<span class="u-ml5 u-text-bold"><?= htmlentities($_SESSION["MONGODB_VERSION"] ?? "8.0") ?></span>
									<a href="/edit/server/mongodb/" class="u-ml5">
										<i class="fas fa-pencil icon-orange"></i>
									</a>
									<a href="/list/mongodb/" class="u-ml5">
						...
						<!-- RabbitMQ -->
						<?php if (!empty($_SESSION["RABBITMQ_SYSTEM"]) && $_SESSION["RABBITMQ_SYSTEM"] == "yes") { ?>
							<div class="u-mb20">
								<p class="u-mb10">
									<i class="fas fa-envelope icon-orange u-mr5"></i>
									<?= _("RabbitMQ") ?>:
									<span class="u-ml5 u-text-bold"><?= _("Enabled") ?></span>
									<a href="/list/rabbitmq/" class="u-ml5">
						...
						<!-- Kafka -->
						<?php if (!empty($_SESSION["KAFKA_SYSTEM"]) && $_SESSION["KAFKA_SYSTEM"] == "yes") { ?>
							<div class="u-mb20">
								<p class="u-mb10">
									<i class="fas fa-stream icon-red u-mr5"></i>
									<?= _("Apache Kafka") ?>:
									<span class="u-ml5 u-text-bold"><?= _("Enabled") ?></span>
									<a href="/list/kafka/" class="u-ml5">
										<i class="fas fa-info-circle icon-blue"></i>
									</a>
								</p>
								<div class="u-pl30">
						...
						<!-- Node.js -->
						<?php if (!empty($_SESSION["NODEJS_SYSTEM"]) && $_SESSION["NODEJS_SYSTEM"] == "yes") { ?>
							<div class="u-mb20">
								<p class="u-mb10">
									<i class="fab fa-node-js icon-green u-mr5"></i>
									<?= _("Node.js") ?>:
									<span class="u-ml5 u-text-bold"><?= _("Enabled") ?></span>
									<a href="/list/nodejs/" class="u-ml5">
										<i class="fas fa-list icon-blue"></i>
									</a>
								</p>
								<div class="u-pl30">
									<p class="hint">
										<?= _("Installed Versions") ?>: <?= htmlentities($_SESSION["NODEJS_VERSIONS"] ?? "20,18") ?>
									</p>
									<p class="hint">
										<?= _("Default Version") ?>: <?= htmlentities($_SESSION["NODEJS_DEFAULT"] ?? "20") ?>
									</p>
								</div>
							</div>
						<?php } ?>
						...
						<!-- Python -->
						<?php if (!empty($_SESSION["PYTHON_SYSTEM"]) && $_SESSION["PYTHON_SYSTEM"] == "yes") { ?>
							<div class="u-mb20">
								<p class="u-mb10">
									<i class="fab fa-python icon-blue u-mr5"></i>
									<?= _("Python") ?>:
									<span class="u-ml5 u-text-bold"><?= _("Enabled") ?></span>
									<a href="/list/python/" class="u-ml5">
										<i class="fas fa-list icon-blue"></i>
									</a>
								</p>
								<div class="u-pl30">
